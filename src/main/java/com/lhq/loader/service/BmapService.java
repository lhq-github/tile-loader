...
public class BmapService implements IMapService {
    private static final Logger logger = LoggerFactory.getLogger(BmapService.class);
    ...
    public Long calculateCount(DownloadParamVO downloadParamVO) {
        ...
        long allSun = 0;
        for (int zoom : zooms) {
            CoordinateToolkit.bd09_LngLat_To_Tile(northwest, zoom, tile1);
            CoordinateToolkit.bd09_LngLat_To_Tile(southeast, zoom, tile2);
